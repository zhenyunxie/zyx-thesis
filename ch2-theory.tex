...
\subsection{Models and Protocols}\label{sub:models_and_protocol}
...
In particular, gNMI (gRPC Network Management Interface) enables both configuration and streaming telemetry, supporting frequent updates with low processing overhead, which is critical for modern data center and optical networks.
