...
In the past several years, the rapid rise of AI has shifted computing from simple neural networks to trillion-parameter models.
...
Processing every packet individually therefore introduces unnecessary overhead. This motivates Optical Circuit Switching (OCS).
% OCS introduction
...
Because switching occurs entirely in the optical domain, OCS is largely protocol and rate transparent.
...
Finally, a major gap exists in system-level SDN integration.
