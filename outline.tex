...
\title{Graph-based Programming Frameworks for Integrated Photonic Switching in Networking Applications}
\author{zhenyun xie}
\maketitle
...
Talk about the state of the art of ocs applications in datacenter.
...
\begin{itemize}
    ...
    \item graphic theory, how to syntheses circuit based on graph
    \item sdn theory
\end{itemize}
